...
<body>
    ...
    <div id="page-wrap">
        ...
        if ($_SESSION['user_id']) {
            ...
            $id_question_1 = explode("-", $answer_1);
            $id_question_2 = explode("-", $answer_2);
            $answer1 = $id_question_1[1];
            $id_answer_1 = $id_question_1[0];
            $answer2 = $id_question_2[1];
            $id_answer_2 = $id_question_2[0];
            $totalCorrect = 0;
            if ($answer1 ==  $_SESSION['results'][$id_answer_1]["answer_correct"] ) {
                $totalCorrect++;
            }
            if ($answer2 == $_SESSION['results'][$id_answer_2]["answer_correct"]) {
                $totalCorrect++;
            }
